...
class Enchantment{
    ...
    public static function init(){
        ...
        /** CUSTOM ENCHANTMENTS */
        self::$enchantments[self::TYPE_WEAPON_WITHER] = new Enchantment(self::TYPE_WEAPON_WITHER, "%enchantment.weapon.wither", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_AXE);

        self::$enchantments[self::TYPE_WEAPON_POISON] = new Enchantment(self::TYPE_WEAPON_POISON, "%enchantment.weapon.poison", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_SWORD);
     
        self::$enchantments[self::TYPE_WEAPON_BLINDNESS] = new Enchantment(self::TYPE_WEAPON_BLINDNESS, "%enchantment.weapon.blindness", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_SWORD);
        self::$enchantments[self::TYPE_WEAPON_CONFUSION] = new Enchantment(self::TYPE_WEAPON_CONFUSION, "%enchantment.weapon.confusion", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_SWORD);
        self::$enchantments[self::TYPE_WEAPON_DISARMOR] = new Enchantment(self::TYPE_WEAPON_DISARMOR, "%enchantment.weapon.disarmor", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_SWORD);
   
        
        //Armor
        self::$enchantments[self::TYPE_ARMOR_CLARITY] = new Enchantment(self::TYPE_ARMOR_CLARITY, "%enchantment.armor.enlighten", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_ARMOR);
        self::$enchantments[self::TYPE_ARMOR_HULK] = new Enchantment(self::TYPE_ARMOR_HULK, "%enchantment.armor.enlighten", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_ARMOR);
        
        self::$enchantments[self::TYPE_ARMOR_SPEED] = new Enchantment(self::TYPE_ARMOR_SPEED, "%enchantment.armor.speed", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_FEET);
        self::$enchantments[self::TYPE_ARMOR_BLESSED] = new Enchantment(self::TYPE_ARMOR_BLESSED, "%enchantment.armor.speed", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_ARMOR);
        self::$enchantments[self::TYPE_ARMOR_SPRINGS] = new Enchantment(self::TYPE_ARMOR_SPRINGS, "%enchantment.armor.speed", self::RARITY_UNCOMMON, self::ACTIVATION_EQUIP, self::SLOT_ARMOR);
        //Pickaxe
